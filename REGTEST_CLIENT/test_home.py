...
def run(t):
    ...
    t.xnee.key('G')
    t.check_image('home_search_student', speed="fast",
                  message='Key stroke in student search')
    ...
    t.check_image('home_average', speed="veryslow")

    t.goto_url("http://%s:8888/=super.user/2008/Test/test_types" % t.server)
    t.check_image('home_types', speed="veryslow")
