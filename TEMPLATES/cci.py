...
def create(table):
    ...
    table.table_attr(p, 'masters', ['parisa.ghodous', 'isabelle.guerin',
                                    'helene.paquien', 'saida.aissa'])
    ...
    column_change(p,'0_5','SIRR','Note','[0;4]','','',0,1)
    column_change(p,'0_6','SIP','Note','[0;4]','','',0,1)
    column_change(p,'0_7','SIG','Note','[0;4]','','',0,1)
    column_change(p,'0_8','????','Note', '[0;4]','','',0,1)
    ...
    column_change(p,'0_20','SIRR','Text','','','',0,1)
    column_change(p,'0_21','SIP','Text','','','',0,1)
    column_change(p,'0_22','SIG','Text','','','',0,1)
    column_change(p,'0_23','????','Text','','','',0,1)
