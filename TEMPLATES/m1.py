...
def create(table):
    ...
    add_master('behzad.shariat-torba')
    add_master('stephanie.j-daubias')
    ...
    column_change(p,'0_5','Ordre des établissements','Text','','','',0,4)
    ...
    column_change(p,'0_10','L3 Classement','Text','','','',0,2)
    column_change(p,'0_11','Recommandation','Text','','','',0,4)
    column_change(p,'0_12','Motivation','Text','','','',0,4)
    column_change(p,'0_13','Remarques','Text','','','',0,4)
    column_change(p,'0_14','On prend','Text','','','',0,1)
    column_change(p,'0_15','Accepte','Text','','','',0,1)
