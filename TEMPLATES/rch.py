...
def create(table):
    ...
    column_change(p,'0_5','CODE','Note','[0;4]','','',0,1)
    column_change(p,'0_6','IGI','Note','[0;4]','','',0,1)
    column_change(p,'0_7','TIWe','Note','[0;4]','','',0,1)
    column_change(p,'0_8','RTS','Note', '[0;4]','','',0,1)
    ...
    column_change(p,'0_20','CODE','Text','','','',0,1)
    column_change(p,'0_21','IGI','Text','','','',0,1)
    column_change(p,'0_22','TIWe','Text','','','',0,1)
    column_change(p,'0_23','RTS','Text','','','',0,1)
