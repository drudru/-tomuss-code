...
translations:
	@for I in TRANSLATIONS/*/LC_MESSAGES LOCAL/TRANSLATIONS/*/LC_MESSAGES ; do echo $$I ; (cd $$I ; $(MAKE) --no-print-directory -f $$(echo $$I | sed -r 's/[^\/]+/../g')/Makefile tomuss.mo) ; if [ $$? != 0 ] ; then exit 1 ; fi ; done
